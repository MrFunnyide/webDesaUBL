...
<template>
   <nav class="navbar navbar-dark navbar-expand-lg d-flex justify-content-center" style="background-color: #557A46;">
      <div class="container">
         <RouterLink class="navbar-brand" to="/">Umbul Limus</RouterLink>
